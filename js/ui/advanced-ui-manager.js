/* ========================================
   ...
   Version corrigée - Mise à jour forcée
   ======================================== */
...
const AdvancedUIManager = (() => {
    ...
    function switchTab(tabName) {
        ...
        /* FORCER la mise à jour du panneau */
        forceUpdateActivePanel();
    }
    
    /* FORCER la mise à jour du panneau actif */
    function forceUpdateActivePanel() {
        // Vide les conteneurs avant de les remplir
        switch(activeTab) {
            case 'derivatives':
                clearDerivativesPanel();
    ...
    function clearDerivativesPanel() {
    ...
    /* PANEL BATIMENTS - Version corrigée */
    ...
    function updateStatsExports() {
        ...
        exports.innerHTML = `
            <div style="background: rgba(255,255,255,0.03); padding: 15px; border-radius: 10px; margin-top: 10px;">
                ...
                <div style="font-size: 0.8rem;">Revenus: <strong>${stats.totalRevenue.toLocaleString()} FCFA</strong></div>
